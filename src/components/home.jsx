           ...
           {/*  <div id="preloder">
            ...
            <div class="offcanvas-menu-wrapper">
                ...
                <div class="offcanvas__nav__option">
                    <a href="/" class="search-switch"><img src={require("../img/icon/search.png")} alt="" /></a>
                    <a href="/"><img src={require("../img/icon/heart.png")} alt="" /></a>
                    <a href="/"><img src={require("../img/icon/cart.png")} alt="" /> <span>0</span></a>
            ...
            <section class="hero">
                <div class="hero__slider owl-carousel">
                    <div class="hero__items set-bg" data-setbg={require("../img/hero/hero-1.jpg")}>
                        <div class="container">
                            <div class="row">
                    ...
                    <div class="hero__items set-bg" data-setbg={require("../img/hero/hero-2.jpg")}>
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-5 col-lg-7 col-md-8">
                                    <div class="hero__text">
                    ...
                    <div class="row product__filter">
                        <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix new-arrivals">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg={require("../img/product/product-1.jpg")}>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix hot-sales">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg={require("../img/product/product-2.jpg")}>
                                    <ul class="product__hover">
                                        <li><a href="/"><img src={require("../img/icon/heart.png")} alt="" /></a></li>
                                        <li><a href="/"><img src={require("../img/icon/compare.png")} alt="" /> <span>Compare</span></a></li>
                                        <li><a href="/"><img src={require("../img/icon/search.png")} alt="" /></a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="footer__about">
                                ...
                                <a href="/"><img src={require("../img/payment.png")} alt="" /></a>
                            </div>
                        </div>
